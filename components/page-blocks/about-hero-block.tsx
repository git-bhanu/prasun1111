        ...
        <div className='grid grid-cols-1 gap-10 md:grid-cols-2 md:gap-16 lg:gap-24'>
          <div className='md:self-end'>
            <SectionReveal delay={0}>
              <div>
                {block.eyebrow ? (
                  <p data-tina-field={tinaField(block, 'eyebrow')} className='mb-5 font-space-grotesk text-[10px] uppercase text-brand-blue md:text-[24px]'>
                    {block.eyebrow}
                  </p>
                ) : null}
                <h1 data-tina-field={tinaField(block, 'statement')} className='font-sedan text-[24px] leading-tight md:text-[80px]'>
          ...
          {block.body ? (
            <SectionReveal delay={0.15}>
              <div
                ...
                className='font-sedan text-[16px] leading-tight md:flex md:flex-col md:justify-center md:text-[36px]'
              >
