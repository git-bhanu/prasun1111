...
function CenterMenu() {
  ...
  return (
    <div className='shrink-0 grow-0' style={{ flexBasis: 354, width: 354, maxWidth: 354 }}>
      <motion.div
      ...
      >
        <div role='img' aria-label='Prasun 1111 logo animation' className='flex h-[50px] min-w-0 flex-1 items-center'>
          <Image src='/uploads/11-logo.svg' width={80} height={30} priority alt='Prasun 1111 Logo' className='h-auto w-20 shrink-0' />
          <div className='h-full shrink-0 overflow-hidden' style={{ width: 50, minWidth: 50 }}>
        ...
        <motion.button
          ...
          className={
            menuExpanded
              ? 'flex size-[38px] items-center justify-center rounded-full bg-brand-orange text-brand-white'
              : 'flex size-[38px] items-center justify-center rounded-full bg-brand-white text-brand-black'
          }
        >
